...
public class ShapeGenerator1 : MonoBehaviour
{
    ...
    private void GenerateShapes()
    {
        ...
        GameObject parentGroup = new GameObject("ShapeGroup1");
        ...
        {
            // Instantiate the shape pref      ab at the spawn position relative to the parent group
    ...
    void Update()
    {
        ...
        {
            //replace redobect default with answer
        }
    }
}